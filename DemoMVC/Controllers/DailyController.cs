...
namespace DemoMVC.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DaiLyId,MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DaiLyId,MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai")] DaiLy daiLy)
        {
            if (id != daiLy.DaiLyId)
            {
                return NotFound();
